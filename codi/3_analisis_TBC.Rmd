...
modelcomplet<-model_HR_RCrisk_clusters(dades,"DM_ajust3",a="grup",failcode = "Event",cencode = "End of follow-up") 
...
forest.plot.modelcomplet(dadesmodel,label="Categoria",mean="HR",lower="Li95%CI",upper="Ls95%CI",label_X="OR (95% CI)", intercept=1)+
