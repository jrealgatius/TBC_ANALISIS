...
# Ajustos
vector_ajustos<-c("","DM_ajust","DM_ajust2","DM_ajust3","DM_ajust4","DM_ajust5","DM_ajust6") %>% 
  stats::setNames(c("Unadjust","Model 1","Model 2","Model 3","Model 4","Model 5","Model 6"))  
...
mom5.1<-Estima_HR_RCrisk_clusters(dades,"DM_ajust6",a="grup",failcode = "Event",cencode = "End of follow-up") 
mom5.2<-Estima_HR_RCrisk_clusters(dades,"DM_ajust6",a="grup2",failcode = "Event",cencode = "End of follow-up") 
mom5.3<-Estima_HR_RCrisk_clusters(dades,"DM_ajust6",a="grup3",failcode = "Event",cencode = "End of follow-up") 
...
modelcomplet<-model_HR_RCrisk_clusters(dades,"DM_ajust6",a="grup",failcode = "Event",cencode = "End of follow-up") 
