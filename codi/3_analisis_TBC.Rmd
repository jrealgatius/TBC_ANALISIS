...
- Generar cohorte dinámica y/o apareada
...
Cohorte estatica a 01/2007 con seguimiento hasta 31/12/2018

Criterios de inclusión: Pacientes DM y controles de **Ciutat Vella** vinculados con el registro del programa de prevención y control de Tuberculosi de Barcelona. 
...
HR.COX(x="v.ajust",event = "event_tbc",t="temps_tbc",d=dades,taulavariables = conductor_variables) %>% kable(digits = 3,caption = "HR ajustats segons covariables") %>% kableExtra::kable_styling()
